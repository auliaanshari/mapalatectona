...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210805_mapalatectonaftiunand_b7aaafe633e0a5c31408_20210805080737_archive.zip';
	const ARCHIVE_SIZE		 = '22573073';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'b7aaafe-05080737';
    const SECONDARY_PACKAGE_HASH = '69d4516-05080737';
	const VERSION			 = '1.4.2';
